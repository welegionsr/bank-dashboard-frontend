...
export async function middleware(req) {
    ...
    try {
        ...
        if (response.status === 200 && response.data.isValid) {
            ...
            res.cookies.set('session_valid', 'true', { maxAge: 300, httpOnly: true, sameSite: 'none' });
            res.cookies.set('session_role', response.data.role, { maxAge: 300, httpOnly: true, sameSite: 'none' });
